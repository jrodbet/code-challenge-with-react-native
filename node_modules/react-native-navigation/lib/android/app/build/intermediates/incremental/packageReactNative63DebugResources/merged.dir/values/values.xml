...
<resources>
    ...
    <item name="original_pivot_x" type="id"/>
    <item name="original_pivot_y" type="id"/>
    <item name="original_right" type="id"/>
    <item name="original_top" type="id"/>
    <item name="original_z_index" type="id"/>
    ...
    <style name="TitleBarSubtitle" parent="TextAppearance.Widget.AppCompat.Toolbar.Subtitle">
        <item name="android:textSize">14dp</item>
    </style>
    <style name="TitleBarTitle" parent="TextAppearance.Widget.AppCompat.Toolbar.Title">
